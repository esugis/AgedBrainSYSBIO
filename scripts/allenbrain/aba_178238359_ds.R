...
resdir <- "~/AgedBrainSYSBIO/results/allenbrain/178238359_ds"
...
maexp <- read.csv(file = "~/AgedBrainSYSBIO/data/allenbrain/178238359_ds/MicroarrayExpression.csv", header = F)
dim(maexp)

# Read ontology
onto <- read.csv(file = "/AgedBrainSYSBIO/data/allenbrain/178238359_ds/Ontology.csv")

# Read in probes names
probes <- read.csv("/AgedBrainSYSBIO/data/allenbrain/178238359_ds/Probes.csv")
dim(probes)

# Read in sample annotations
sampleann <- read.csv("/AgedBrainSYSBIO/data/allenbrain/178238359_ds/SampleAnnot.csv")
dim(sampleann)
