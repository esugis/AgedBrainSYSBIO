...
# Path to the results  
pathRdata <- "~/absb/results/allenbrainatlas/tissues_rdata/"
...
s1 <- read.csv(file = "/home/nikolaeva/AgedBrain/ppi2_data/allenbrainatlas/178236545_ds/SampleAnnot.csv")
s2 <- read.csv(file = "/home/nikolaeva/AgedBrain/ppi2_data/allenbrainatlas/178238266_ds/SampleAnnot.csv")
s3 <- read.csv(file = "/home/nikolaeva/AgedBrain/ppi2_data/allenbrainatlas/178238316_ds/SampleAnnot.csv")
s4 <- read.csv(file = "/home/nikolaeva/AgedBrain/ppi2_data/allenbrainatlas/178238359_ds/SampleAnnot.csv")
