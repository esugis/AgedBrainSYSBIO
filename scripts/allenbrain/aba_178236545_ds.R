...
resdir <- "~/absb/results/allenbrain/178236545_ds"
...
maexp <- read.csv(file = "~/absb/data/allenbrain/178236545_ds/MicroarrayExpression.csv", header = F)
dim(maexp)
...
sampleann <- read.csv("~/absb/data/allenbrain/178236545_ds/SampleAnnot.csv")
dim(sampleann)
