...
epi=read.table(file="~/absb/data/epistasis/epistatic_bin-bin_interactions_at_MAF_prod_GE_0.01_bonf_pvalue_LE_1.0E-11.tsv", header=T)
...
length(epi_adni_igri_ensg)#1146
library(stringr)
