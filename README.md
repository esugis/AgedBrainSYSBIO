...
#### 2.2 Processing of the gene expression datasets from Allen Brain Atlas.
Location: “ ~/AgedBrainSYSBIO/scripts/allenbrain”

2.2.1 Scripts for the preprocessing of the individual datasets.
...
2.2.2 Calculate z scores in each of the tissue in all data sets "aba_zcores.R".

2.2.3 Assemble matrix of z-scores for all probes in the datasets from individual results for each tissue "aba_scores_assemble.R".

2.2.4 Convert probe names to Ensembl namespace "probes2ensg.R".

2.2.5 Select maximum z-scores for probes corresponding to the same Ensembl gene name "zscores_select_max.R".
